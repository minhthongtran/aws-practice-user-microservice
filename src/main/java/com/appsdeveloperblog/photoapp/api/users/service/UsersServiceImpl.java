...
public class UsersServiceImpl implements UsersService {
	...
	@Override
	public List<com.appsdeveloperblog.photoapp.api.users.data.User> getUsersJason() {
		com.appsdeveloperblog.photoapp.api.users.data.User[] entities = restTemplate.getForObject("https://jsonplaceholder.typicode.com/users", com.appsdeveloperblog.photoapp.api.users.data.User[].class);
